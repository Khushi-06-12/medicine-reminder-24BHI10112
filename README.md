...
This project addresses a common real-world problem — forgetting medication schedules — and provides a lightweight digital solution using basic web technologies.
...
* Add medicine names
* Set a specific time for each medicine
* Receive a popup reminder at the scheduled time
...
3. Click **Add**
4. The medicine will appear in the list
5. At the scheduled time, you will receive a **popup reminder**
...
* For testing, always set time slightly ahead of current time
